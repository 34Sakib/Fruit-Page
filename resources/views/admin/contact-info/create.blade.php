    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form method="POST" action="{{ route('admin.contact-info.store') }}?_method=POST">
                    @csrf
                    <div class="card-body">
                        @if($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="header_icon" name="header_icon" 
                                           value="{{ old('header_icon', 'fas fa-headset') }}" placeholder="fas fa-headset">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="header_subtitle" name="header_subtitle" rows="3">{{ old('header_subtitle') }}</textarea>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="email_hours" name="email_hours" 
                                           value="{{ old('email_hours') }}" placeholder="24/7 Support">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone_hours" name="phone_hours" 
                                           value="{{ old('phone_hours') }}" placeholder="Mon-Sat 9AM-8PM">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="map_embed_url" name="map_embed_url" rows="4" 
                                      placeholder="Paste Google Maps embed iframe code here">{{ old('map_embed_url') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="map_address" name="map_address" 
                                   value="{{ old('map_address') }}" placeholder="123 Organic Street, Freshville, Dhaka 1205, Bangladesh">
                        </div>
