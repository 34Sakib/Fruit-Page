...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.about-us.team.update', $teamMember) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        @if($teamMember->image_path)
                                            <img id="previewImg"
                                                 src="{{ asset('storage/' . $teamMember->image_path) }}"
                                    ...
                                    <div class="col-md-8">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="role" class="form-control"
                                                           value="{{ old('role', $teamMember->role) }}" required>
                                            ...
                                            <tr>
                                                <th>Description *</th>
                                                <td>
                                                    <textarea name="description" rows="4" class="form-control" required>{{ old('description', $teamMember->description) }}</textarea>
