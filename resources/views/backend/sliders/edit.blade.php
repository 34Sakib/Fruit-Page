                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="button_link" id="button_link" class="form-control @error('button_link') is-invalid @enderror" value="{{ old('button_link', $slider->button_link) }}" placeholder="https://example.com">
                                                @error('button_link')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if($slider->image)
                                            <img id="imagePreview" src="{{ asset('storage/' . $slider->image) }}" alt="{{ $slider->title }}" class="img-fluid mt-2 image-preview">
                                        @else
                                            <img id="imagePreview" src="#" alt="Preview" class="img-fluid mt-2 image-preview" style="display: none;">
                                        @endif
    ...
    <script>
        ...
        document.getElementById('image').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                @if($slider->image)
                    preview.src = '{{ asset('storage/' . $slider->image) }}';
                    preview.style.display = 'block';
                @else
                    preview.src = '#';
